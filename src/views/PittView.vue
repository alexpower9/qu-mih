<template>
    ...
    <HockeyPlayer :position="'RD'" :team="2" :tooltipText="tooltipsActive ? 'Get out to the LW.' : ''" :top="playerPositions.team2.RD.top" :left="playerPositions.team2.RD.left" class="team-2-RD"></HockeyPlayer>
